...
data homework.model_variables_2;
	SET homework.model_variables_2;
	Profit = earn_fc_m/at_m; label Profit = "Profitability";
	Payout =dvc_m/at_m; label payut = "Payout";
	Growth = (earn_fc_m-earn_m)/earn_m;label growth = "Growth";
	EV_Sales =(chso_m*prcc_f_m+lt_m-che_m)/sale_m;label EV_Sales = "Enterprice value sales multipe";
	Risk = Beta_m; label Risk = "Risk";
run;
...
proc means data=homework.model_variables_2 N mean median std;
	var EV_Sales Profit Payout Growth Risk;
...
proc export data = descriptive_statistics_Task3
...
%Macro RIRollReg2;
	...
	%do i = 2009 %to 2018;
		...
		proc reg data = homework.model_variables_2 outest = _2_reg_parms_&i. tableout noprint;
			...
			model EV_Sales = Profit Payout Growth Risk;
		quit;
