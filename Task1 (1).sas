...
o	To obtain expected earnings, compute one-year ahead earnings forecast for the years 
2000 to 2018 (HouYear), in line with the approach used in the tutorials. 
